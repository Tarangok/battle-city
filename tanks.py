...
class Tank():
	...
	def __init__(self, level, side, position = None, direction = None, filename = None):
		...
		self.controls = [joystick.get_button( 0 ), pygame.K_UP, pygame.K_RIGHT, pygame.K_DOWN, pygame.K_LEFT]
						...
						if player.state == player.STATE_ALIVE:
							if joystick.get_button( 0 ):
								if player.fire() and play_sounds:
									sounds["fire"].play()
							elif joystick.get_hat( 0 ) == (0, 1) or joystick.get_axis( 1 ) <= -0.7:
								print("UP")
								player.pressed[0] = True
							elif joystick.get_hat( 0 ) == (1, 0) or joystick.get_axis( 0 ) >= 0.7:
								player.pressed[1] = True
							elif joystick.get_hat( 0 ) == (0, -1) or joystick.get_axis( 1 ) >= 0.7:
								player.pressed[2] = True
							elif joystick.get_hat( 0 ) == (-1, 0) or joystick.get_axis( 0 ) <= -0.7:
								player.pressed[3] = True
							elif joystick.get_hat( 0 ) == (0, 0) and joystick.get_axis( 1 ) < 0.7 and joystick.get_axis( 0 ) < 0.7 and joystick.get_axis( 1 ) > -0.7 and joystick.get_axis( 0 ) > -0.7:
